...
```bash
tools/pdfbuild/build-pdf.sh en v0.2
tools/pdfbuild/build-pdf.sh pt-br v0.2

make docs-pdf \
  PDF_SRC_EN=tools/pdfbuild/out/rgb-system-core-v0.2-en.pdf \
  PDF_SRC_PT_BR=tools/pdfbuild/out/rgb-system-core-v0.2-pt-br.pdf
```
