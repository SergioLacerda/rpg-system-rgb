  ...
  "pt-br": {
    ...
    skills: {
      ...
      pathfinder: {
        name: "Pathfinder",
        status: "instalada",
        desc: "Especialista na documentação do RGB System. Responde dúvidas sobre regras, indica o capítulo exato da Library e resolve ambiguidades entre versões.",
        tags: [
          "busca em toda a Library",
          "explica vetores R·G·B",
          "cita fonte .md",
        ],
      },
      maker: {
        ...
        desc: "Converte histórias e aventuras em rascunho para documentos estruturados — padrão RGB System por default, exportável para outros sistemas.",
        tags: [
          "texto bruto → .md estruturado",
          "mapeia p/ vetores R·G·B",
          "export multi-sistema",
        ],
      },
    },
  ...
  en: {
    ...
    skills: {
      ...
      pathfinder: {
        name: "Pathfinder",
        status: "installed",
        desc: "Documentation specialist for the RGB System. Answers rules questions, points to the exact Library chapter, and resolves ambiguity between versions.",
        tags: [
          "searches the whole Library",
          "explains R·G·B vectors",
          "cites the source .md",
        ],
      },
      maker: {
        ...
        desc: "Converts raw stories and adventures into structured documents — RGB System by default, exportable to other systems.",
        tags: [
          "raw text → structured .md",
          "maps to R·G·B vectors",
          "multi-system export",
        ],
      },
    },
