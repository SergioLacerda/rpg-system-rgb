...
Shields are **defensive equipment or energy fields** that preserve a character
under pressure.
...
Energy shields represent the **absorption layer** in the RGB damage system and
are a typed expression of B as preservation.
