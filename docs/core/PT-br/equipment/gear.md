...
Equipamentos no sistema RGB seguem três princípios de design:

- **utilidade acima da complexidade** – equipamentos devem permitir ações em vez de introduzir mecânicas pesadas
- **flexibilidade tática** – itens devem permitir soluções criativas
- **adaptabilidade ao cenário** – equipamentos podem variar dependendo do mundo da campanha

Por exemplo:

- cenários modernos podem incluir eletrônicos e equipamentos táticos
- cenários de fantasia podem incluir ferramentas mágicas
- cenários de ficção científica podem incluir tecnologia avançada

## Relação com Outros Sistemas

Equipamentos interagem com vários módulos do RGB:

```text
Equipamentos → apoiam ações de gameplay
Armas → causam dano
Armaduras → reduzem dano
Escudos → absorvem dano
```

Devido a essa separação, os equipamentos permanecem **simples e modulares** dentro do sistema RGB.
