...
```text
R → pode aumentar impacto em armas corpo a corpo quando a Fonte de Impacto permite
G → permite evitar ataques por mobilidade, timing e posicionamento
B → fornece preservação por bloqueios, escudos e estabilização
```
